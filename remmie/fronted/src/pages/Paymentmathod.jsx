...
export default function PaymentMethods() {
  ...
  const fetchCards = async () => {
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_API_URL}/stripe/user-payment-methods-list`,
  ...
  const deleteCard = async (id) => {
    ...
    try {
      await axios.post(
        `${import.meta.env.VITE_API_URL}/stripe/user-payment-methods-delete`,
        { card_id: id },
        { headers: { Authorization: `Bearer ${token}` } }
      );
      fetchCards();
  ...
  const setDefaultCard = async (id) => {
    try {
      await axios.post(
        `${import.meta.env.VITE_API_URL}/stripe/user-payment-methods-setdefault`,
        { card_id: id },
        { headers: { Authorization: `Bearer ${token}` } }
      );
      fetchCards();
  ...
  const handleSaveCard = async () => {
    ...
    try {
      ...
      // 2. Send to backend
      await axios.post(
        `${import.meta.env.VITE_API_URL}/stripe/user-payment-methods-add`,
