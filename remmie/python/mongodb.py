...
def save_flight_offers(recipient_id: str, offers: dict) -> bool:
    """
    Save the raw Amadeus flight-offers response JSON for later use/bookings.
    """
    doc = {
        "recipient_id": recipient_id,
        "offers": offers,
    ...
    result = db.flight_offers.insert_one(doc)
    return bool(result.inserted_id)